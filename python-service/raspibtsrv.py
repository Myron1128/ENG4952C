...
def main():
    ...
    while True:
        ...
        try:
            ...
            #Try checking for crash here and send alert like this:
            # response = "rear" or response = "front"
            ...
            # Insert more here
            # This is an extra request
            elif data.split(":")[0] == "speed":
                # store the speed and do something with it
                response = "msg: Received speed of " + data.split(":")[1]
            elif data == "shutdown":
                call("sudo shutdown -h now", shell=True)
                response = "msg:Raspberry has shutdown"
            else:
